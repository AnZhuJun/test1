                ...
                <form class="form-horizontal" method="post" id="up-form" action="/finalscore/finalscore" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" id="first" name="first" placeholder="请输入第一大题得分">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" id="second" name="second" placeholder="请输入第二大题得分">
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" id="third" name="third" placeholder="请输入第三大题得分">
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" id="fourth" name="fourth" placeholder="请输入第四大题得分">
                        </div>
                     </div>
