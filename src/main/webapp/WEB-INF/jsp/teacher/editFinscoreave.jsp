    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 600px;margin:0 auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="add-form" action="/finscoreave/update" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="courseid" name="courseid"
                                   placeholder="请输入课程编码" value="${fsav.courseid}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden"  class="form-control" value="${fsav.teacherid}" id="teacherid" name="teacherid">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number"  class="form-control" value="${fsav.classid}" id="classid" name="classid" placeholder="请输入班级编号">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number"  class="form-control" value="${fsav.dt}" id="dt" name="dt" placeholder="请输入大题号">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number"  class="form-control" value="${fsav.xt}" id="xt" name="xt" placeholder="请输入小题号">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number"  class="form-control" value="${fsav.averange}" id="averange" name="averange" placeholder="请输入应得分">
                        </div>
                    </div>

                    <input type="hidden" name="fsavid" value="${fsav.fsavid}">
