    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 600px;margin:0 auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="add-form" action="/psscoreave/update" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="courseid" name="courseid"
                                   placeholder="请输入课程编码" value="${psav.courseid}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden"  class="form-control" value="${psav.teacherid}" id="teacherid" name="teacherid">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number"  class="form-control" value="${psav.classid}" id="classid" name="classid" placeholder="请输入班级编号">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number"  class="form-control" value="${psav.averange}" id="averange" name="averange" placeholder="请输入平均分">
                        </div>
                    </div>

                    <input type="hidden" name="psavid" value="${psav.psavid}">
