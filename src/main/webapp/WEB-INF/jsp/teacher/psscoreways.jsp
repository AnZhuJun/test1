...
<div style="text-align: center">
    ...
    <a href="?username=${name}&start=${psscoreway.number-1}">[上一页]</a>
    <a href="?username=${name}&start=${psscoreway.number+1}">[下一页]</a>
    <a href="?username=${name}&start=${psscoreway.totalPages-1}">[末  页]</a>
</div>
