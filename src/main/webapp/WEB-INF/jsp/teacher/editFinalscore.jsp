            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="add-form" action="/finalscore/update" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.year}" id="year" name="year" placeholder="请输入优秀">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.term}" id="term" name="term" placeholder="请输入良好">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.time}" id="time" name="time" placeholder="请输入及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.point}" id="point" name="point" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.studentid}" id="studentid" name="studentid" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.classid}" id="classid" name="classid" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.name}" id="name" name="name" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.first}" id="first" name="first" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.second}" id="second" name="second" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.third}" id="third" name="third" placeholder="请输入不及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${fs.fourth}" id="fourth" name="fourth" placeholder="请输入不及格">
                        </div>
                    </div>
