    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach items="${psscoreaves.content}" var="u" varStatus="vs">
            <tr>
                ...
                <td>${u.teacherid}</td>
                <td>${u.averange}</td>
                <td><a href="/psscoreave/delete/${u.psavid}"><span class="glyphicon glyphicon-trash"></span></a></td>
                <td><a href="/psscoreave/edit?id=${u.psavid}"><span class="glyphicon glyphicon-edit"></span></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 650px;margin:auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="up-form1" action="/psscoreave/search" enctype="multipart/form-data">
...
<div class="container">
    <div class="row" >
        <div class="panel panel-default" style="width: 650px;margin:auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="up-form" action="/psscoreave/psscoreave" enctype="multipart/form-data">
                    <div class="form-group">

                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" value="${psavTeacherId.teacherid}" id="teacherid" name="teacherid">
                        </div>
