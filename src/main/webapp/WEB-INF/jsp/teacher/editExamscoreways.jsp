    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 600px;margin:0 auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="add-form" action="/examscoreways/update" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="courseid" name="courseid"
                                   placeholder="请输入课程编码" value="${esw.courseid}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden"  class="form-control" value="${esw.teacherid}" id="teacherid" name="teacherid">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${esw.best}" id="best" name="best" placeholder="请输入优秀">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${esw.good}" id="good" name="good" placeholder="请输入良好">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${esw.soso}" id="soso" name="soso" placeholder="请输入及格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" value="${esw.worse}" id="worse" name="worse" placeholder="请输入不及格">
                        </div>
                    </div>

                    <input type="hidden" name="scorewayid" value="${esw.scorewayid}">
