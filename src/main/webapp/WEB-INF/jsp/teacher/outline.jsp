...
<table class="table table-hover table-striped">
    ...
    <c:forEach items="${files}" var="u" varStatus="vs">
        <tr>
            ...
            <td>${u.name}</td>
            <td><a href="/outline/download?id=${u.outlineid}"><span class="glyphicon glyphicon-edit"></span></a></td>
            <td><a href="/outline/delete?id=${u.outlineid}"><span class="glyphicon glyphicon-trash"></span></a></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 650px;margin:auto">
            ...
            <div class="panel-body" >
                <form action="/outline/outline" method="post" enctype="multipart/form-data">
