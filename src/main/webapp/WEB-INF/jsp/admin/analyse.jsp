...
<div class="container" >
    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach items="${aanalyses.content}" var="u" varStatus="vs">
            <tr>
                <td>${u.coursename}</td>
                <td>${u.teachername}</td>
                <td>${u.classname}</td>
                ...
                <td>${u.sumworse}</td>
                <td>${u.achidegree}</td>
                <td><a href="/analyse/aedit?id=${u.analyseid}"><span class="glyphicon glyphicon-edit"></span></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
...
<div style="text-align: center">
    ...
    <a href="?username=${name}&start=${aanalyses.number-1}">[上一页]</a>
    <a href="?username=${name}&start=${aanalyses.number+1}">[下一页]</a>
    <a href="?username=${name}&start=${aanalyses.totalPages-1}">[末  页]</a>
</div>
    ...
    <div class="row" >
        <div class="panel panel-default" style="width: 650px;margin:auto">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="up-form1" action="/analyse/asearch" enctype="multipart/form-data">
